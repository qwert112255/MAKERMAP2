...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{"mBlock 影像互動設計","智能無人載具開發工作坊"};
        String[] str2 = new String[]{"主辦：創客萊吧 MakerLab","主辦：百創整合行銷有限公司"};
        String[] str3 = new String[]{"時間：12/8 10:00 – 16:00","時間：12/10 09:30 – 12/11 17:00"};
        String[] str4 = new String[]{"報名："+"https://ppt.cc/fK2bzx","報名："+"https://ppt.cc/f5bkFx"};
