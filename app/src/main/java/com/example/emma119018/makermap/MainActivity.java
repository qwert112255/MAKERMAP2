...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{"Arduino四軸飛行器開發實作","Python姿態控制和影像處理特戰班","Python 學習地圖與攻略","手刻橡皮章 x 聖誕節卡片DIY"};
        String[] str2 = new String[]{"主辦：T客邦創客基地","主辦：中軟科技有限公司","主辦：三創育成基金會","主辦：慕耕活茶研所"};
        String[] str3 = new String[]{"時間：1/5 17:30 – 19:30","時間：1/5 13:00 – 17:00","時間：1/4 19:30 – 21:30","時間：12/22 19:00 – 21:30"};
        String[] str4 = new String[]{"報名：http://bit.ly/2Auau3J","報名：http://bit.ly/2ArNhiJ","報名：http://bit.ly/2Aqz3hS","報名：http://bit.ly/2SELOwk"};
