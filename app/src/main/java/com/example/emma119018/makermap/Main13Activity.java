...
public class Main13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_home:
                        ...
                        intent3.setClass(Main13Activity.this,ChooseActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.navigation_dashboard:
                        Intent intent6 = new Intent();
                        intent6.setClass(Main13Activity.this,MapsActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.navigation_notifications:
                        Intent intent5 = new Intent();
                        intent5.setClass(Main13Activity.this,AboutActivity.class);
        ...
        String[] str1 = new String[]{"藍草長出的循環經濟"};
        String[] str2 = new String[]{"主辦：品樂東海"};
        String[] str3 = new String[]{"時間：12/3 19:00 – 21:00"};
        String[] str4 = new String[]{"報名：https://ppt.cc/fZFhUx"};
