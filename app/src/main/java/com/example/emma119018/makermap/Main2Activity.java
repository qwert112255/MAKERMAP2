...
public class Main2Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{
                "藍草長出的循環經濟","注連繩","皮革手環DIY","柴柴胸針/迷你相框"
                };
        String[] str2 = new String[]{
                "主辦：品樂東海","主辦：This Place 分享空間","主辦：工藝之夢－好玩藝設計講堂","主辦：目目手作"
                 };
        String[] str3 = new String[]{
                "時間：12/3 19:00 – 21:00","時間：1/20 14:00 – 17:00","時間：1/20 16:00 – 18:00","時間：1/26 9:00 – 12:30"
                };
        String[] str4 = new String[]{
                "報名：https://ppt.cc/fZFhUx","報名：http://bit.ly/2SyDSwO","報名：http://bit.ly/2Swa83F","報名：http://bit.ly/2SwairN"
               };
