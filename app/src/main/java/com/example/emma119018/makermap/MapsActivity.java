...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigation1.setSelectedItemId(R.id.navigation_dashboard);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions()
                .position(HCH)
                .title("華僑高中FabLab")
                .snippet("地址：新北市板橋區大觀路一段32號"+'\n'+
                        "電話：02-29684131#201"+'\n'+
                        "設備：3D列印機、CNC、3D掃瞄機、雷射雕刻機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：新北市板橋區大觀路二段28號"+'\n'+
                        "電話：02-82751414#204"+'\n'+
                        "設備：3D列印機、雷射雕刻機、3D掃瞄機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(DM)
                .title("夢基地木創")
                .snippet("地址：新北市汐止區鄉長路2段169號"+'\n' +
                        "電話：02-26426675/0987-840-995"+'\n'+
                        "設備：手鋸、鉋刀、鑿刀.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(DLU)
                .title("德霖技術學院3D列印實驗室")
                .snippet("地址：新北市土城區青雲路380巷1號機械館3樓308"+'\n'+
                        "電話：02-22733567#396"+'\n'+
                        "設備：CNC、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(IOT)
                .title("物聯網創客基地")
                .snippet("地址：新北市五股區五工五路47號7樓"+'\n'+
                        "電話：02-89956399#2799"+'\n'+
                        "設備：3D列印機、雷射雕刻機、金屬雕刻機、平台式切割機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台北市中正區八德路一段1號"+'\n'+
                        "電話：02-33224749"+'\n'+
                        "設備：3D列印機、雷射雕刻機、3D掃瞄機、3D列印筆.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台北市中正區汀州路三段230巷37弄8號"+'\n'+
                        "電話：02-23645313"+'\n'+
                        "設備：3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台北市大安區和平東路二段134號"+'\n'+
                        "電話：02-27321104#63465/#70010"+'\n'+
                        "設備：3D列印機、雷射雕刻機../3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(DTU)
                .title("大同大學未來產房")
                .snippet("地址：台北市中山區中山北路三段40號"+'\n'+
                        "電話：02-55760311"+'\n'+
                        "設備：雷射雕刻機、CNC、車床、帶鋸機、鑽床、線鋸機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(TNUH)
                .title("師大附中附製工坊")
                .snippet("地址：台北市大安區信義路三段143號"+'\n'+
                        "電話：02-27075215"+'\n'+
                        "設備：3D列印機、雷射雕刻機、CNC、帶鋸機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(IF)
                .title("點子工場 / 自造工坊")
                .snippet("地址：台北市忠孝東路三段193巷"+'\n'+
                        "電話：02-27712171#1460"+'\n'+
                        "設備：3D列印機、雷射雕刻機、VR、3D列印筆.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(CYU)
                .title("崇右技術學院創意商品設計系")
                .snippet("地址：基隆市信義區義七路40號"+'\n'+
                        "電話：02-24237785#556#557"));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(NLU)
                .title("內壢高中FabLab")
                .snippet("地址：桃園市中壢區成章四街120號"+'\n'+
                        "電話：03-4528080#211"+'\n'+
                        "設備：3D列印機、3D掃描機、雷射雕刻機、CNC、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(NCU)
                .title("中央大學創意園區")
                .snippet("地址：桃園市中壢區中大路300號"+'\n'+
                        "電話：03-4227151"+'\n'+
                        "設備：CNC、3D列印機、雷射雕刻機、真空成形機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(YC)
                .title("青創指揮部")
                .snippet("地址：桃園市中壢區環北路390號3樓"+'\n'+
                        "電話：03-4225205"+'\n'+
                        "設備：3D列印機、CNC、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(ICFB)
                .title("衣啟飛翔創客基地")
                .snippet("地址：新竹市北區武陵路10號"+'\n'+
                        "電話：03-4855368#625#620"+'\n'+
                        "設備：3D列印機、熱轉印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：新竹市光復路二段101號"+'\n'+
                        "電話：03-5751201"+'\n'+
                        "設備：3D列印機、雷射雕刻機、CNC、3D掃瞄機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(MLH)
                .title("苗栗農工FabLab")
                .snippet("地址：苗栗縣苗栗市經國路二段491號"+'\n'+
                        "電話：03-7329281#601"+'\n'+
                        "設備：3D列印機、3D掃瞄機、雷射雕刻機、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(TCH)
                .title("台中高工FabLab")
                .snippet("地址：台中市南區高工路191號"+'\n'+
                        "電話：04-22613158#7010#7011"+'\n'+
                        "設備：3D列印機、CNC、車床.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台中市西屯區台灣大道四段1727號"+'\n'+
                        "電話：04-23594646#30"+'\n'+
                        "設備：雷射雕刻機、車床、銑床、鑽床、砂輪機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(CSH)
                .title("清水高中自造實驗室")
                .snippet("地址：台中市清水區中山路90號科學館2樓"+'\n'+
                        "電話：0935-387-268"+'\n'+
                        "設備：雷射雕刻機、3D掃描機、CNC、3D列印機、磨床、鑽床.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(MV)
                .title("Maker Village")
                .snippet("地址：嘉義縣民雄鄉三興村7鄰大學路一段168號"+'\n'+
                        "電話：0958-065-568"+'\n'+
                        "設備：雷射雕刻機、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(TTH)
                .title("台南二中FabLab" )
                .snippet("地址：台南市北區北門路二段125號"+'\n'+
                        "電話：06-2514526#604#305"+'\n'+
                        "設備：雷射雕刻機、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(THH)
                .title("台南海事FabLab" )
                .snippet("地址：台南市安平區世平路1號"+'\n'+
                        "電話：06-3910772#211"+'\n'+
                        "設備：雷射雕刻機、3D列印機、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(NFM)
                .title("南方創客基地" )
                .snippet("地址：台南市新營區大同路32號"+'\n'+
                        "電話：06-6356583"+'\n'+
                        "設備：雷射雕刻機、3D掃描機、CNC、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(PD)
                .title("台南胖地" )
                .snippet("地址：台南市中西區南門路21號4樓"+'\n'+
                        "電話：06-2212245"+'\n'+
                        "設備：雷射雕刻機、3D列印機、CNC、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台南市永康區崑大路195號"+'\n'+"　　　工程一館2樓E1202/4樓" +'\n'+
                        "電話：06-2727175#329/#330"+'\n'+
                        "設備：雷射雕刻機、AR、VR、3D列印機.."+'\n'+"　　　雷射切割機、印刷電路板雕刻機、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .snippet("地址：台南市歸仁區長大路1號第一宿舍地下一樓"+'\n'+
                        "電話：06-2785123"+'\n'+
                        "設備：木工車床、雷射雕刻機、3D列印機、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(NCKU)
                .title("成電創客學園" )
                .snippet("地址：台南市東區大學路1號自強校區奇美樓1樓"+'\n'+
                        "電話：06-2372845"+'\n'+
                        "設備：3D列印機、穿戴式裝置.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(KSD)
                .title("高師大FabLab" )
                .snippet("地址：高雄市燕巢區深中路62號"+'\n'+
                        "電話：07-7172930#7501/0933-304-689"+'\n'+
                        "設備：雷射切割機、3D列印機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(FSH)
                .title("鳳山商工FabLab" )
                .snippet("地址：高雄市鳳山區文衡路51號"+'\n'+
                        "電話：07-7417823/0929-288-157"+'\n'+
                        "設備：3D印表機、3D掃描機、CNC、雷射雕刻機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(FLM)
                .title("FI LAB創夢工場" )
                .snippet("地址：高雄市燕巢區大學路1號"+'\n'+
                        "電話：07-6011000#1420-1422"+'\n'+
                        "設備：3D列印機、雷射雕刻機、CNC、電腦割字繪圖機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(ML)
                .title("MakerLab創客萊吧" )
                .snippet("地址：高雄市左營區博愛二路202號地下一樓"+'\n'+
                        "電話：07-5564686/0932-882-942"+'\n'+
                        "設備：3D列印機、雷射雕刻機、CNC、車床.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(MSC)
                .title("創客小棧" )
                .snippet("地址：高雄市前鎮區凱旋四路105號"+'\n'+
                        "電話：07-8210171#2866"+'\n'+
                        "設備：3D列印機、車床、铣床、鑽孔機、雷射雕刻機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(YSU)
                .title("義守大學智慧型機器人中心" )
                .snippet("地址：高雄市大樹區學城路一段1號科技大樓9樓"+'\n'+
                        "電話：07-6577711#2124"));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(NUK)
                .title("高雄大學應用物理學系" )
                .snippet("地址：高雄市楠梓區高雄大學路700號518-1實驗室"+'\n'+
                        "電話：07-5918879"));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(CZU)
                .title("慈濟科技大學創客空間" )
                .snippet("地址：花蓮縣花蓮市建國路二段880號"+'\n'+ "　　　研究發展處 智耕樓5樓"+'\n'+
                        "電話：03-8572158#2755"+'\n'+
                        "設備：3D列印機、雷射雕刻機、UV直噴機.."));
        ...
        mMap.addMarker(new MarkerOptions()
                .position(HLH)
                .title("花蓮高工東區自造實驗室" )
                .snippet("地址：花蓮縣花蓮市府前路27號"+'\n'+
                        "03-8226108#661"+'\n'+
                        "電話：3D列印機、雷射雕刻機、CNC、3D掃描機.."));
