...
public class Main20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{"2018創業小聚高雄特別場","Maker手作自動泡泡機","Spinbox傻瓜唱機組裝"};
        String[] str2 = new String[]{"主辦：高雄市政府經濟發展局","主辦：創客萊吧 MakerLab","主辦：M.ZONE大港自造特區"};
        String[] str3 = new String[]{"時間：11/19 18:30 – 11/20 21:00","時間：11/29 19:00 – 21:00","時間：12/8 14:00 – 17:00"};
        String[] str4 = new String[]{"報名："+"https://ppt.cc/fuh5Gx","報名："+"https://ppt.cc/fkSR1x","報名："+"https://ppt.cc/f0KkIx"};
