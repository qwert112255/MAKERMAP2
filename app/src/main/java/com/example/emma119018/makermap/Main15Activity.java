...
public class Main15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{"木頭小型仿生獸手作體驗","藍草長出的循環經濟"};
        String[] str2 = new String[]{"主辦：成美文化園","主辦：品樂東海"};
        String[] str3 = new String[]{"時間：11/8 14:00 – 16:00","時間：12/3 19:00 – 21:00"};
        String[] str4 = new String[]{"報名："+"https://ppt.cc/fnjPax","報名："+"https://ppt.cc/fZFhUx"};
