...
public class Main17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] str1 = new String[]{"Maker手作自動泡泡機","Spinbox傻瓜唱機組裝"};
        String[] str2 = new String[]{"主辦：創客萊吧 MakerLab","主辦：M.ZONE大港自造特區"};
        String[] str3 = new String[]{"時間：11/29 19:00 – 21:00","時間：12/8 14:00 – 17:00"};
        String[] str4 = new String[]{"報名："+"https://ppt.cc/fkSR1x","報名："+"https://ppt.cc/f0KkIx"};
